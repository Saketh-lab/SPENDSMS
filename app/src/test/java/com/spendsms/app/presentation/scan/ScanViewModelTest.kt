...
class ScanViewModelTest {
    ...
    private fun viewModel(
        ...
        subscriptions: SubscriptionDetectionService = mockk(relaxed = true),
        dashboard: DashboardService = mockk(relaxed = true),
    ): ScanViewModel {
        val scans = mockk<ScanStateRepository>(relaxed = true)
        ...
        return ScanViewModel(
            ...
            preferences = preferences,
            subscriptionDetectionService = subscriptions,
